...
internal fun FavouritesListLayout(
    ...
    Scaffold(
        ...
        if (favourites.isEmpty()) {
            EmptyFavourites(modifier = Modifier.padding(internalPadding))
            return@Scaffold
        }
                ...
                Card(
                    ...
                    Row(
                        ...
                        Column(
                            ...
                            Text(
                                text = favourite.recipe.title,
                                style = MaterialTheme.typography.titleMedium,
                            )
                            Text(
                                text = "${favourite.recipe.servings} servings",
